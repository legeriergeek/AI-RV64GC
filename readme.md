...
On my machine (i3-10100f), it can do approximately ~~80 to 90 MIPS~~ 170 MIPS (Rev. 2).\
It hides itself as qemu for compatibility's sake, but this has nothing to do with qemu.\
In total, it took about ~~10 hours~~ ~12 hours (Rev. 2) for the AIs to build it.
### Realised by 
* #### Rev. 1: `Claude Opus 4.6`, `Claude Sonnet 4.6`, `Gemini 3.1 Pro` & `Gemini 3 Flash`. 
* #### Rev. 2: Rev. 1 + `GLM 5.3 Flash` & `Minimax M3`
## How to use:
